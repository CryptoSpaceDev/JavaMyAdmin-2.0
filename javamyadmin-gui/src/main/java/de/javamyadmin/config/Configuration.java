...
public class Configuration {
    ...
    public static void loadFrom(InputStream inputStream, ErrorReporter reporter) throws IOException {
        ...
        Map<String, ConfigurationParameter<?>> parameters = ConfigurationParameter.getParameters();
        ...
        for (String line = reader.readLine(); line != null; line = reader.readLine()) {
            ...
            parseLine(parameters, reader.getLineNumber(), lineTrimmed, reporter);
        }
    }

    private static void parseLine(Map<String, ConfigurationParameter<?>> parameters, int lineNumber, String line, ErrorReporter reporter) {
    ...
    private static <T> void loadValue(ConfigurationParameter<T> parameter, String value) throws CouldNotDeserializeValueException {
        Deserializer<T> deserializer = parameter.getDeserializer();
        T val = deserializer.deserialize(value);
        parameter.setValue(val);
    }

    public static void saveTo(OutputStream outputStream, ErrorReporter reporter) throws IOException {
        ...
        printStream.println();
        parameters.forEach((key, value) -> writeLine(parameters.get(key), index.getAndIncrement(), printStream, reporter));
    }
