...
public class Configuration {
    ...
    public static void saveTo(OutputStream outputStream, ErrorReporter reporter) {
        ...
        printStream.println("""
            ...
            ##          `.____.'  |_____||_____||____| |____|   |_______|(_)'.____.'           ##
            ##                                                                                 ##
            #####################################################################################
                                    """);
        printStream.println();
        ...
        printStream.println();
        printStream.println();
        ConfigurationParameter.iterateParameters(parameter -> writeParameter(parameter, index.getAndIncrement(), printStream, reporter));
    }

    private static <T> void writeParameter(ConfigurationParameter<T> parameter, int lineNumber, PrintStream printStream, ErrorReporter reporter) {
